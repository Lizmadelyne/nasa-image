...
function Home(){
    ...
    return(
        ...
        <div className=" grid  gap[10rem] md:grid-cols-2 items center ">
            <div>
            <div className="p-4 text-3xl text-gray-500 flex text-center">
            <h1 className="text-medium  text-blue-950 p-3 ">{apodData.title}</h1>
            </div>
            <img className="object-cover h-2/3  m-auto" src={apodData.url} alt={apodData.title}></img> 
            </div>
            <div className="p-4 mt-4">
                <h2 className="mb-4 p-3 text-blue-950 text-xl">Description: </h2>
                <p className=" m-auto text-center text-lg p-1 mb-3">{apodData.explanation}</p>
              </div>
        </div>
